...
//	db, err := gorm.Open("postgres", "host=tantor.db.elephantsql.com port=5432 user=yvrvqewb dbname=yvrvqewb password=sf95rtFPhXxvO8-Ag9T-fXJhZdRbRWL3 sslmode=disable")
	url, err := pq.ParseURL("postgres://mfcxfcekxkoied:0725ab75b1bac8d58ec9275d7f44c9f92ccddd9492f8b931d6d860012b526188@ec2-54-235-132-202.compute-1.amazonaws.com:5432/dcifucdgknmloa?sslmode=disable")
